"""
Isolated tests for atomic operations module that don't require full risk system.

These tests focus on the atomic operations functionality in isolation.
"""
...
# Add the parent directory to Python path to import modules directly
...
class TestPerformanceAndScaling:
    ...
    async def test_many_concurrent_different_tokens(self, cleanup_atomic_manager):
        ...
        manager = cleanup_atomic_manager
        # Use a smaller number that fits within the manager's limits
        num_operations = min(20, manager.max_concurrent_operations)
        results = []
