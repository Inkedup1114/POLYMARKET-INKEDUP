...
class EnhancedExposureTracker:
    ...
    async def _get_detailed_exposure(self, positions: List[Position]) -> Dict[str, Any]:
        ...
        for position in positions:
            ...
            market_breakdown[market]['outcomes'][outcome]['unrealized_pnl'] += position.unrealized_pnl
            market_breakdown[market]['outcomes'][outcome]['positions'].append(asdict(position))
