...
class MarketDataProvider:
    ...
    def __init__(
        self, ws_stream: WSStream, order_client: OrderClient, config: BotConfig
    ):
    ...
    async def get_market_data(self, market_id: str) -> MarketData | None:
    ...
    async def _get_market_info(self, market_id: str) -> dict[str, Any] | None:
    ...
    def _parse_market_info(self, data: dict[str, Any]) -> MarketData:
        ...
        return MarketData(
            ...
            mid_price=(float(data.get("bestBid", 0)) + float(data.get("bestAsk", 0)))
            / 2,
        )
...
class VolatilityCalculator:
    ...
    async def calculate_volatility(self, market_id: str) -> VolatilityMetrics | None:
...
class LiquidityAnalyzer:
    ...
    async def analyze_liquidity(self, market_id: str) -> LiquidityMetrics | None:
...
class MarketStatusChecker:
    ...
    async def check_market_status(self, market_id: str) -> MarketStatus | None:
        """Check market status."""
...
def create_market_data_components(
    ws_stream: WSStream, order_client: OrderClient, config: BotConfig
):
