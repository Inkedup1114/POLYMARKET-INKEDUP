...
from inkedup_bot.models.ws_messages import TradeMessage, OrderMessage, BookMessage, parse_websocket_message
from inkedup_bot.models.state import OrderState, PositionState, TradingState, OrderLifecycle, PositionSide
...
def test_order_state():
    ...
    print(f"  After fill - filled: {order.filled_size}, remaining: {order.remaining_size}")
